...
public:
    ...
    virtual void                render_view(const c_viewsetup &view, int nClearFlags, int whatToDraw) = 0;
    ...
    virtual const c_viewsetup*   get_player_view_setup(void) const = 0;
    virtual const c_viewsetup*   get_view_setup(void) const = 0;
    ...
    virtual void                queue_overlay_render_view(const c_viewsetup &view, int nClearFlags, int whatToDraw) = 0;
