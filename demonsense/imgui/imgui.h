...
namespace ImGui
{
    ...
    //IMGUI_API ImGuiComboBox* CreateCombo(const char* name, ImVec2 size);
    ...
    IMGUI_API bool          BeginChildS(const char* str_id, const ImVec2& size_arg = ImVec2(0, 0), const ImVec2& pos_arg = ImVec2(0, 0), bool border = true, ImGuiWindowFlags flags = 0);
    ...
    IMGUI_API void          Separator(float w = 0.f);                                       // separator, generally horizontal. inside a menu bar or in horizontal layout mode, this becomes a vertical separator.
    ...
    IMGUI_API void          TextS(const char* fmt, ...);
    IMGUI_API void          TextSized(float size, const char* fmt, ...);
    IMGUI_API bool          LabelClick(const char* concatoff, const char* concaton, const char* label, bool* v, const char* unique_id);
    ...
    IMGUI_API bool          ButtonS(const char* label, const ImVec2& size = ImVec2(0, 0));   // button
    ...
    IMGUI_API bool          ColorEdit3(const char* label, Color* color, ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorEdit4(const char* label, Color* color, ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorPicker3(const char* label, Color* col, ImGuiColorEditFlags flags = 0);
    IMGUI_API bool          ColorPicker4(const char* label, Color* color, ImGuiColorEditFlags flags = 0, const float* ref_col = NULL);
    ...
    IMGUI_API bool          ListBoxHeader(const char* label, const ImVec2& size_arg = ImVec2(0,0)); // use if you want to reimplement ListBox() will custom data or interactions. if the function return true, you can output elements then call ListBoxFooter() afterwards.
...
enum ImGuiInputTextFlags_
{
    ...
    ImGuiInputTextFlags_OnSlider            = 1 << 21,   // On slider
    ImGuiInputTextFlags_OnInput             = 1 << 22   // On slider
};
...
enum ImGuiColorEditFlags_
{
    ...
    ImGuiColorEditFlags_OnSlider        = 1 << 27,
    ImGuiColorEditFlags_OnCheckbox      = 1 << 28,
