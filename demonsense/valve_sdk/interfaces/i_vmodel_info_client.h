...
public:
	...
	virtual void                            get_model_materials(const model_t *model, int count, i_material** ppMaterial) = 0;
	...
	virtual void                            get_model_material_color_and_lighting(const model_t *model, Vector const& origin, QAngle const& angles, trace_t* pTrace, Vector& lighting, Vector& matColor) = 0;
	virtual void                            get_illumination_point(const model_t *model, i_client_renderable*pRenderable, Vector const& origin, QAngle const& angles, Vector* pLightingCenter) = 0;
	...
	virtual bool                            is_using_fb_texture(const model_t *model, int nSkin, int nBody, i_client_renderable* *pClientRenderable) const = 0;
...
class i_vmodelinfo_client : public i_vmodel_info
{
public:
};
